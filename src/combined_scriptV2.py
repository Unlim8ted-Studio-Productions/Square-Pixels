if __name__ == "__main__":
    ...
    if __name__ == "__main__":
        start()        import SquarePixels.enemymanagement.enemy as enemy
        ...
        class Enemy_manager:
            ...
            def update(self, x, y, air, objectinfo, colliders, screen, player, day):
                ...
                for creature in self.creatures:
                    creature.update(x, y, colliders, air, player, screen)            import pygame as pig
            import random
            import math
            ...
            class Enemy:
                    ...
                    if self.direction:
                        ...
                        if self.spit:
                            if len(self.lspitattack) != 0:
                                ...
                                self.lspitattack.pop(0)                import SquarePixels.render.render as render
                import pygame as pig
                ...
                def game(
                    ...
                    if __name__ == "__main__":
                        ...
                        # Quit the program
                        pygame.quit()                                import pygame as pig
                                import typing
                                import colorsys
                                import math
                                import random
                                ...
                                class Player:
                                    ...
                                    class Nametag:
                                        ...
                                        def draw(self, screen: pig.Surface) -> None:
                                            ...
                                            screen.blit(text, text_rect)                                        import math
                                        ...
                                        def LightAlgorithm(colors, x, y, playerX, playerY, TimeOfDay):
                                            ...
                                            return colorslist                                            import pygame
                                                                ...
                                                                def draw_death_screen(screen, width, height, xp):
                                                                    ...
                                                                    if __name__ == "__main__":
                                                                        ...
                                                                        while running:
                                                                            ...
                                                                            pig.display.update()                                                                        import pygame as pig
                                                                        import os
                                                                        ...
                                                                        def play_intro_video(image_folder, not_skipped, screen, intro):
                                                                            ...
                                                                            pig.mixer.music.stop()                                                                            import os
                                                                            import PIL
                                                                            import pygame
                                                                            import sys
                                                                                        ...
                                                                                        def change_text(self, event):
                                                                                            ...
                                                                                            if event.type == pygame.KEYDOWN and self.active:
                                                                                                if event.key == pygame.K_BACKSPACE:
                                                                                                    ...
                                                                                                    self.text += event.unicode                                                                                        import pygame
                                                                                        ...
                                                                                        class InputField:
                                                                                            ...
                                                                                            class Cloud:
                                                                                                ...
                                                                                                def draw(self, screen):
                                                                                                    ...
                                                                                                    screen.blit(self.image, (self.x, self.y))                                                                                                import pygame
                                                                                                from playfab.PlayFabClientAPI import (
                                                                                                            ...
                                                                                                            class CheckBox:
                                                                                                                ...
                                                                                                                class ImageElement:
                                                                                                                    ...
                                                                                                                    def draw(self, screen):
                                                                                                                        ...
                                                                                                                        screen.blit(pygame_image, (self.x, self.y))                                                                                                                    import pygame
                                                                                                                    import sys
                                                                                                                        ...
                                                                                                                        class UIPanel:
                                                                                                                            ...
                                                                                                                            def draw(self, screen):
                                                                                                                                ...
                                                                                                                                for element in self.elements:
                                                                                                                                    element.draw(screen)                                                                                                                            import playfab
